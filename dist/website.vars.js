...
function c(s) {
    var i, t, e, r, c, l, d = s.length, h = [1732584193, -271733879, -1732584194, 271733878];
    for (i = 64; i <= d; i += 64)
...
export function encrypt(password, anyChar, keepSpecialChars) {
    let res = x.hash(password, anyChar);
    !keepSpecialChars && (res = res.replace(/[\x00-\x1f\x7f]/g, ''));
    return res;
}
export function fastEncrypt(password) {
